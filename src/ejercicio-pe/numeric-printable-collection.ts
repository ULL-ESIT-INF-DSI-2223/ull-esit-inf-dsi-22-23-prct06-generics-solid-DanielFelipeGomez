// Extienda la clase abstracta genérica 'PrintableCollection' 
// escribiendo la subclase 'NumericPrintableCollection'. Esta 
// clase deberá modelar una colección de elementos numéricos en 
// la que el método print devolverá la representación en 
