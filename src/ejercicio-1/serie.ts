...
/**
 * Clase encargada de modelar el comportamiento de un contenido stream serie
 */
export class Serie implements StreamableProperties, StreamablePrintable{
    /**
     * Contructor de la clase Serie 
    ...
    /**
     * Método encargado de retornar una cadena que representa la información del Serie
